...
public class Tailor_Search extends Product_pramotion {
	...
	public void explore_CategoriesList_Response() throws IOException
	{
		...
		RestAssured.baseURI=T_Search;
		RequestSpecification httpRequest=RestAssured.given();
		Response resp=httpRequest.get(T_Search);
	...
	{
		Response resp1=RestAssured.get(T_Search);
